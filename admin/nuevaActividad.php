        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                <li><a href="listaActividades.php">Lista</a></li>
                <li class="active"><a href="nuevaActividad.php">Añadir</a></li>
              </ul>
            </li>
          </ul>
        </div><!--/.nav-collapse -->
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-8 col-lg-offset-2"> 
          ...
          <form role="form" action="insertarAct.php" method="post" enctype="multipart/form-data">
            <div class="form-group">
              <label for="ejemplo_email_1">Titulo de la actividad</label>
              <input type="text" class="form-control" id="titulo" name="titulo" placeholder="Escribe un titulo a la actividad">
            </div>
            <div class="form-group">
              <label for="ejemplo_password_1">Información de la actividad</label>
              <textarea class="form-control" id="info" name="info" placeholder="Escribe la información de la actividad" rows="5"></textarea>
            </div>
            <div class="form-group">
